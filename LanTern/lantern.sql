...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 28, 2021 at 11:17 PM
...
CREATE TABLE `grad` (
  ...
  `nazivGrada` varchar(50) COLLATE utf8_unicode_ci NOT NULL
...
CREATE TABLE `kategorija` (
  ...
  `nazivKategorija` varchar(20) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `korisnici` (
  ...
  `slika` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `oglasi` (
  ...
  `slikaOglas` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  `idKategorija` int(5) NOT NULL,
  `idGrad` int(5) NOT NULL,
  `idKorisnik` int(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1, 'Matematika', 'Diplomirani profesor matematike drži časove za osnovce, srednjoškolce i studente. Individualni časovi i grupni.', 700, '../assets/images/oglasi/1.jpg', 1, 1, 2),
...
CREATE TABLE `porukeadmin` (
  ...
  `emailKorisnik` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `poruka` varchar(300) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `oglasi`
  MODIFY `idOglasa` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `omiljenioglas`
--
ALTER TABLE `omiljenioglas`
  MODIFY `idOmiljeniOglas` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
